...
import (
	...
	. "github.com/bitnami-labs/helm-apiserver/pkg/client/clientset_generated/clientset/typed/helm/v1alpha1"
...
var _ = Describe("Release controller", func() {
	...
	BeforeEach(func() {
		...
		expectedKey = "release-controller-test-handler/instance-1"
	})
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.HelmV1alpha1().Releases("release-controller-test-handler")
