...
import (
	...
	scheme "github.com/bitnami-labs/helm-apiserver/pkg/client/clientset_generated/internalclientset/scheme"
...
type ReleaseInterface interface {
	Create(*helm.Release) (*helm.Release, error)
	Update(*helm.Release) (*helm.Release, error)
	UpdateStatus(*helm.Release) (*helm.Release, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*helm.Release, error)
	List(opts v1.ListOptions) (*helm.ReleaseList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *helm.Release, err error)
	ReleaseExpansion
}
...
func newReleases(c *HelmClient, namespace string) *releases {
	return &releases{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *releases) Get(name string, options v1.GetOptions) (result *helm.Release, err error) {
	result = &helm.Release{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("releases").
...
func (c *releases) List(opts v1.ListOptions) (result *helm.ReleaseList, err error) {
	result = &helm.ReleaseList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("releases").
...
func (c *releases) Create(release *helm.Release) (result *helm.Release, err error) {
	result = &helm.Release{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("releases").
...
func (c *releases) Update(release *helm.Release) (result *helm.Release, err error) {
	result = &helm.Release{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("releases").
...
func (c *releases) UpdateStatus(release *helm.Release) (result *helm.Release, err error) {
	result = &helm.Release{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("releases").
...
func (c *releases) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *helm.Release, err error) {
	result = &helm.Release{}
