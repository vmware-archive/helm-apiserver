...
import (
	...
	scheme "github.com/bitnami-labs/helm-apiserver/pkg/client/clientset_generated/clientset/scheme"
...
func newReleases(c *HelmV1alpha1Client, namespace string) *releases {
	return &releases{
		client: c.RESTClient(),
		ns:     namespace,
	}
